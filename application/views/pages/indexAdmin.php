    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="indexAdmin.php">EC- Administrator</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-users fa-user"></i> Usuarios<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Lista de usuarios</a>
                                </li>
                                <li>
                                    <a href="morris.html">Dar de Baja</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         <li>
                            <a href="#"><i class="fa fa-credit-card fa-credit-card"></i> Pedidos<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Pedidos Pendientes</a>
                                </li>
                                <li>
                                    <a href="morris.html">Todos los pedidos</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-shopping-cart fa-shopping-cart"></i> Productos<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Nuevo producto</a>
                                </li>
                                <li>
                                    <a href="morris.html">Modificar producto</a>
                                </li>
                                <li>
                                    <a href="morris.html">Eliminar producto</a>
                                </li>
                                <li>
                                    <a href="morris.html">Todos los productos</a>
                                </li>
